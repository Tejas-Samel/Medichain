...
export default function PatientDashBoard() {
  ...
  function emergencycard() {
    // console.log("------------ECC----------------")
    // console.log(Emergencyacc);
    // console.log(Emergencyacc.length);
    // console.log(Emergencyacc.data);
    ...
    for (let i = 0; i < Emergencyacc.length; i++) {
      ...
      <Grid item xs={12} sm={6} md={4}>
        <Card>
          <CardContent>
        <Typography>HospitalId : {Emergencyacc[i].hospitalId}</Typography>
        <Typography>Time When Accessed </Typography>
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          ...
          >
            ...
            <Grid item xs={12} style={{ display: "none" }} id="emergencycontact">
              {emergencycontact}
            </Grid>
