...
class insuranceLogin extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      ...
      //           </Grid>
      //           <Grid item>
      //             <Link href="/registerInsurance" variant="body2">
              ...
              <div className="col-sm-6 text-black">
                ...
                <div className="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                  ...
                  <form style={{ width: "23rem" }} noValidate onSubmit={this.submitForm}>
                    ...
                    <h3 className="fw-normal mb-3 pb-3" style={{ letterSpacing: "1px" }}>Insurance Log in</h3>
                    {ifalert ? (
                    ...
                    <div className="form-outline mb-4">
                      ...
                      <input type="registrationId" defaultValue={this.state.registrationId}
                        label="registrationId" className="form-control form-control-lg"
                        onChange={this.handleChange} name="registrationId"
                        helperText={this.state.errors.registrationId}
                        id="registrationId" />
