...
class pharmacyLogin extends Component {
  ...
  render() {
    ...
    return (
      ...
      //           </Grid>
      //           <Grid item>
      //             <Link href="/registerPharmacy" variant="body2">
          ...
          <div className="container-fluid bg-light" style={{ borderRadius: "25px" }}>
            <div className="row">
              <div className="col-sm-6 text-black">
                ...
                <div className="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                  ...
                  <form style={{ width: "23rem" }} noValidate onSubmit={this.submitForm}>
                    ...
                    <h3 className="fw-normal mb-3 pb-3" style={{ letterSpacing: "1px" }}>Pharmacy Log In</h3>
                    ...
                    <div className="form-outline mb-4">
                      <label className="form-label" htmlFor="registrationId">Registration Number</label>

                      <input name="registrationId" defaultValue={this.state.registrationId}
                        label="Registration Number" className="form-control form-control-lg"
                        onChange={this.handleChange}
                        helperText={this.state.errors.registrationId}
                        id="registrationId" />
                    ...
                    <p>Don't have an account? <a href="/registerPharmacy" variant="body2">
              ...
              <div className="col-sm-6 px-0 d-none d-sm-block" >
                <img src="https://images.pexels.com/photos/3683088/pexels-photo-3683088.jpeg?auto=compress&cs=tinysrgb&w=1600"
