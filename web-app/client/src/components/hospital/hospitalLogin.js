          ...
          <div className="container-fluid bg-light" style={{ borderRadius: "25px" }}>
            <div className="row">
              ...
              <div className="col-sm-6 px-0 d-none d-sm-block" >
                <img src="https://images.unsplash.com/photo-1632833239869-a37e3a5806d2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8aG9zcGl0YWwlMjBidWlsZGluZ3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
