...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        let registeredUser = await databaseHandler.registerNewUser(req.body.registrationId, req.body.name, 'Researcher');
        res.send("Correct");
...
async function registerInLedger(req) {
    ...
    try {
        ...
        let response = await contract.submitTransaction('createResearcher', JSON.stringify(req.body));
