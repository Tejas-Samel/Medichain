...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        let registeredUser = await databaseHandler.registerNewUser(req.body.registrationId, req.body.name, 'Pharmacy');
        res.send("Correct");
...
async function registerInLedger(req) {
    ...
    try {
        ...
        let response = await contract.submitTransaction('createPharmacy', JSON.stringify(req.body));
